...
public class LikeSide_Adapter extends ArrayAdapter<String> {
    ...
    private List<String> nameList = new ArrayList<>(), dateList = new ArrayList<>(), lastMessage = new ArrayList<>(), headerList = new ArrayList<>();

    public LikeSide_Adapter(@NonNull Context context, @NonNull ArrayList<String> names, @NonNull ArrayList<String> dates, @NonNull ArrayList<String> lastMessage, @NonNull ArrayList<String> headerList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String currentLastMessage = lastMessage.get(position);
