...
public class ChatDTO {
    ...
    private String chatId, header, user1, user2, user1ID, user2ID;
    ...
    public ChatDTO(ArrayList<String> sender, ArrayList<String> messages , String chatId, ArrayList<Date> dates, ArrayList<String> receiver, ArrayList<Uri> pictures, String header, String user1, String user2, String user1ID, String user2ID) {
        this.chatId = chatId;
        this.dates = dates;
